...
var main = new Vue({
  ...
  data: {
    ...
    descriptions: [
      ...
      // Look for 'Common Properties with God'
      ...
      // How the mind can order its own emotions--in fear, it can find courage, in
      // hatred, love, etc.
    ...
    // This will include all 5 steps that Spinoza mentions, whereas the top section
    // can include Deleuze's 3 demystifications. Consider how to incorporate this
    // into other sections
    reflections: ['Test'],
    relatedItems: ['desire'],
    references: [
